        ...
        const checkUsernameUnique = async () => {
            if(username){
                ...
                try {
                    ...
                    console.log("RESPONSE UNIQUE USERNAME: ", response);
                }
                catch (error) {
        ...
        <div className="flex justify-center items-center min-h-screen bg-gray-100">
            <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-lg shadow-lg">
                <div className="text-center">
                    <h1 className="text-4xl font-extrabold tracking-tight mb-6 lg:text-5xl">Join Mystery Message</h1>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <p className={`text-sm ${isUsernameUnique ? "text-green-600" : "text-red-600"}`}>{usernameMessage}</p>
                                    <FormMessage />
                                </FormItem>
                            )}
                        />
